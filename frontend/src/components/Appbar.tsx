...
export const Appbar = ()=>{
    ...
    return <div className="border-b-4 border-black rounded-b-2xl bg-slate-200 flex justify-between px-4 py-4">
        ...
        <div className="flex justify-center">
            <Link to={`/publish`}>
                <button type="button" className=" mr-2 text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center ">New +</button>
            </Link>
            ...
            <Link to={`/signin`} onClick={
                ...
                <button type="button" className="pl-4 lg:pl-2">
